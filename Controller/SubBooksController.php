...
class SubBooksController extends SubscriptionAppController {
  
  public $name = 'SubBooks';

  public $uses = array('Plugin', 'User', 'Members.Mypage', 'Members.Mylog', 'Subscription.SubBook');
